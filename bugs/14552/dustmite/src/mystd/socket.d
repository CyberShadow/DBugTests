...
import core.stdc.stdint, core.stdc.string, mystd.string, core.stdc.stdlib, mystd.conv;
...
version(Windows)
{
    ...
    private import core.sys.windows.windows, core.sys.windows.winsock2, mystd.windows.syserror;
...
static if (is(sockaddr_un))
{
    ...
    unittest
    {
        ...
        auto name = mystd.file.deleteme ~ "-unix-socket";
