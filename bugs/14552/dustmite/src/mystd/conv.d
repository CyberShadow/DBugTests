...
public import mystd.ascii : LetterCase;
...
private string convFormat(Char, Args...)(in Char[] fmt, Args args)
{
    ...
    return mystd.format.format(fmt, args);
}
...
{
    import mystd.ascii : isDigit, isAlpha, toLower, toUpper, isHexDigit;
    import mystd.exception : enforce;
...
unittest
{
    import core.stdc.stdlib, mystd.math;
    ...
    if (isInputRange!Source && isSomeChar!(ElementType!Source))
{
    ...
    {
        import mystd.ascii : isAlpha, isHexDigit;
        if (s_.empty)
            throw parseError("Unterminated escape sequence");
        s_.popFront();
        if (s_.empty)
...
unittest //@@@9559@@@
{
    ...
    import mystd.typecons : Nullable;
