...
$(LINK2 std_algorithm.html, mystd.algorithm) or $(LINK2 std_range.html,
mystd.range).
...
private uint _ctfeSkipOp(ref string op)
{
    ...
    import mystd.ascii : isASCII, isAlphaNum;
...
deprecated("Please use mystd.functional.partial instead")
alias curry = partial;
...
unittest
{
    import mystd.functional, mystd.typecons;
