 ...
 */
module mystd.algorithm.mutation;

import mystd.range.primitives;
import mystd.traits : isBlitAssignable, isNarrowString;
// FIXME
    ...
    if (isInputRange!Range && hasLvalueElements!Range && hasAssignableElements!Range)
{
    ...
    import mystd.traits : hasElaborateAssign, isDynamicArray;
...
{
    import mystd.algorithm.iteration : filter;
    import mystd.traits : hasElaborateAssign;
...
void move(T)(ref T source, ref T target)
{
    ...
    import mystd.traits : hasAliasing, hasElaborateAssign,
                        hasElaborateCopyConstructor, hasElaborateDestructor,
                        isAssignable;

    static if (!is( T == class) && hasAliasing!T) if (!__ctfe)
    {
        import mystd.exception : doesPointTo;
...
if (isBidirectionalRange!Range
    && hasLvalueElements!Range)
{
    import mystd.functional : unaryFun;
    auto result = range;
...
{
    import mystd.traits : hasAliasing, hasElaborateAssign, isAssignable,
                        isStaticArray;
...
{
    //11853
    import mystd.traits : isAssignable;
...
unittest // 9975
{
    import mystd.exception : doesPointTo, mayPointTo;
    static struct S2
    {
        union
        {
