 ...
 */
module mystd.algorithm.comparison;
...
in
{
    import mystd.functional : greaterThan;
...
@safe unittest
{
    import mystd.algorithm.iteration : map;
    import mystd.math : approxEqual;
    import mystd.internal.test.dummyrange : ReferenceForwardRange,
...
private struct Levenshtein(Range, alias equals, CostType = size_t)
{
    EditOp[] path()
    {
        import mystd.algorithm.mutation : reverse;
    ...
    if (T.length >= 2)
{
    ...
    import mystd.functional : lessThan;
