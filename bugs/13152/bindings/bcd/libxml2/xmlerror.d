...
alias _BCD_func__1971 xmlStructuredErrorFunc;
alias void function(void *, char *, ...) _BCD_func__1926;
alias _BCD_func__1926 xmlGenericErrorFunc;
...
extern (C) int xmlCopyError(_xmlError *, _xmlError *);
extern (C) void xmlResetError(_xmlError *);
extern (C) void xmlCtxtResetLastError(void *);
extern (C) _xmlError * xmlCtxtGetLastError(void *);
extern (C) void xmlResetLastError();
extern (C) _xmlError * xmlGetLastError();
extern (C) void xmlParserPrintFileContext(_xmlParserInput *);
extern (C) void xmlParserPrintFileInfo(_xmlParserInput *);
extern (C) void xmlParserValidityWarning(void *, char *, ...);
extern (C) void xmlParserValidityError(void *, char *, ...);
extern (C) void xmlParserWarning(void *, char *, ...);
extern (C) void xmlParserError(void *, char *, ...);
extern (C) void xmlSetStructuredErrorFunc(void *, _BCD_func__1971);
extern (C) void initGenericErrorDefaultFunc(_BCD_func__1926 *);
extern (C) void xmlSetGenericErrorFunc(void *, _BCD_func__1926);
