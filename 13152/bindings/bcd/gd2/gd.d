...
alias int function(void *, char *, int) _BCD_func__827;
alias gdPoint * gdPointPtr;
alias gdFTStringExtra * gdFTStringExtraPtr;
alias gdSource * gdSourcePtr;
alias int function(void *, char *, int) _BCD_func__831;
alias gdFont * gdFontPtr;
alias gdImageStruct gdImage;
alias gdImageStruct * gdImagePtr;
alias gdIOCtx * gdIOCtxPtr;
alias int function(gdIOCtx *) _BCD_func__835;
alias int function(gdIOCtx *, void *, int) _BCD_func__836;
alias void function(gdIOCtx *, int) _BCD_func__837;
alias int function(gdIOCtx *, void *, int) _BCD_func__838;
alias int function(gdIOCtx *, int) _BCD_func__839;
alias int function(gdIOCtx *) _BCD_func__840;
alias void function(gdIOCtx *) _BCD_func__841;
...
alias int function(void *) _BCD_func__292;
alias int function(void *, long *, int) _BCD_func__294;
alias int function(void *, char *, uint) _BCD_func__296;
alias int function(void *, char *, uint) _BCD_func__298;
alias void function(void *) _BCD_func__683;
alias int function(void * *, char *) _BCD_func__684;
alias int function(char *, char * * *, uint *) _BCD_func__685;
alias int function(void *, char *, char *, char *, char *) _BCD_func__686;
struct gdSink {
_BCD_func__827 sink;
void * context;
}
...
struct gdIOCtx {
_BCD_func__835 getC;
_BCD_func__836 getBuf;
_BCD_func__837 putC;
_BCD_func__838 putBuf;
_BCD_func__839 seek;
_BCD_func__840 tell;
_BCD_func__841 gd_free;
}
