...
class Stream : InputStream, OutputStream {
  private import mystd.string, mystd.digest.crc, mystd.c.stdlib, mystd.c.stdio;
...
class File: Stream {
  ...
  void open(string filename, FileMode mode = FileMode.In) {
    ...
    writeable = cast(bool)(mode & FileMode.Out);
    version (Windows) {
      hFile = CreateFileW(mystd.utf.toUTF16z(filename), access, share,
