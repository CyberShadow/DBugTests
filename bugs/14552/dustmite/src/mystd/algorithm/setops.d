...
import mystd.traits;
// FIXME
import mystd.typetuple; // : TypeTuple, staticMap, allSatisfy, anySatisfy;
...
{
    import mystd.algorithm.iteration : map, joiner;

    static if (isInfinite!R1 && isInfinite!R2)
    {
        static if (isForwardRange!R1 && isForwardRange!R2)
        {
            import mystd.range : zip, repeat, take, chain, sequence;
...
@safe unittest
{
    import mystd.algorithm.searching : canFind;
    import mystd.range;
...
{
    import mystd.algorithm: cartesianProduct;
    int[1] a = [1];
...
import mystd.algorithm.sorting : SortOutput; // FIXME
...
{
    import mystd.algorithm.iteration : group;
    import mystd.algorithm.sorting : topNCopy;
...
struct NWayUnion(alias less, RangeOfRanges)
{
    ...
    {
        import mystd.algorithm.mutation : remove, SwapStrategy;
