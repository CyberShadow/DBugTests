...
*/
module mystd.regex.internal.parser;

import mystd.regex.internal.ir;
import mystd.algorithm, mystd.range, mystd.uni, mystd.typetuple,
    mystd.traits, mystd.typecons, mystd.exception;
...
auto makeRegex(S)(Parser!S p)
{
    ...
    with(re)
    {
        ...
        //@@@BUG@@@ (not reduced)
        //somehow just using validate _collides_ with mystd.utf.validate (!)
