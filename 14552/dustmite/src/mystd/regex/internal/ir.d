/*
    Implementation of mystd.regex IR, an intermediate representation
...
*/
module mystd.regex.internal.ir;

package(mystd.regex):

import mystd.exception, mystd.uni, mystd.typetuple, mystd.traits, mystd.range;
...
{
    import mystd.array, mystd.format;
...
package(mystd.regex):
    import mystd.regex.internal.kickstart; //TODO: get rid of this dependency
...
//@@@BUG@@@ (unreduced) - public makes it inaccessible in mystd.regex.package (!)
