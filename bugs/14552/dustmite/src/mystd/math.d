 ...
 * Mathematical special functions are available in $(D mystd.mathspecial).
 *
...
unittest
{
    assert(equalsDigit(tan(PI / 3), mystd.math.sqrt(3.0), useDigits));
}
...
unittest
{
    assert(equalsDigit(acos(0.5), mystd.math.PI / 3, useDigits));
}
...
unittest
{
    assert(equalsDigit(atan(mystd.math.sqrt(3.0)), PI / 3, useDigits));
}
...
unittest
{
    assert(equalsDigit(atan2(1.0L, mystd.math.sqrt(3.0L)), PI / 6, useDigits));
}
...
unittest
{
    import mystd.typetuple, mystd.typecons;
