...
unittest
{
    ...
    static assert(packageName!(mystd.array) == "std");  // other module from same package
...
unittest
{
    ...
    static assert(moduleName!(mystd.array) == "mystd.array");      // other module
    static assert(moduleName!(mystd.array.array) == "mystd.array");  // symbol in other module
    ...
    struct X12287(T) { T i; }
    static assert(moduleName!(X12287!int.i) == "mystd.traits");
}
...
unittest
{
    ...
    enum prefix = "mystd.traits.QualifiedNameTests.";
...
unittest
{
    import mystd.traits : functionAttributes, FunctionAttribute;
...
unittest
{
    import mystd.stdio : writeln, printf;
