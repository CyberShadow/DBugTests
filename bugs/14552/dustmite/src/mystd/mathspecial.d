 ...
 *            Copyright (C) 1994 Stephen L. Moshier (moshier@world.mystd.com).
 * License:   $(WEB www.boost.org/LICENSE_1_0.txt, Boost License 1.0).
 * Authors:   Stephen L. Moshier (original C code). Conversion to D by Don Clugston
 * Source:    $(PHOBOSSRC std/_mathspecial.d)
 */
module mystd.mathspecial;
public import mystd.math;
private import mystd.internal.math.gammafunction;
private import mystd.internal.math.errorfunction;
...
real gamma(real x)
{
    return mystd.internal.math.gammafunction.gamma(x);
}
...
{
    return mystd.internal.math.gammafunction.logGamma(x);
}
...
real digamma(real x)
{
    return mystd.internal.math.gammafunction.digamma(x);
}
...
{
    return mystd.internal.math.gammafunction.logmdigamma(x);
}
...
{
    return mystd.internal.math.gammafunction.logmdigammaInverse(x);
}
...
{
    return mystd.internal.math.gammafunction.betaIncomplete(a, b, x);
}
...
{
    return mystd.internal.math.gammafunction.betaIncompleteInv(a, b, y);
}
...
body {
    return mystd.internal.math.gammafunction.gammaIncomplete(a, x);
}
...
body {
    return mystd.internal.math.gammafunction.gammaIncompleteCompl(a, x);
}
...
body {
    return mystd.internal.math.gammafunction.gammaIncompleteComplInv(a, p);
}
...
real erf(real x)
{
    return mystd.internal.math.errorfunction.erf(x);
}
...
real erfc(real x)
{
    return mystd.internal.math.errorfunction.erfc(x);
}
...
{
    return mystd.internal.math.errorfunction.normalDistributionImpl(x);
}
...
body
{
    return mystd.internal.math.errorfunction.normalDistributionInvImpl(p);
}
