 ...
 */
module mystd.algorithm.sorting;

import mystd.algorithm.mutation : SwapStrategy;
import mystd.functional; // : unaryFun, binaryFun;
import mystd.range.primitives;
// FIXME
import mystd.range; // : SortedRange;
import mystd.traits;
...
{
    import mystd.algorithm : bringToFront; // FIXME
    import mystd.range : chain, assumeSorted;
...
{
    import mystd.algorithm : bringToFront, swap; // FIXME;
...
@safe unittest
{
    import mystd.algorithm : count, find; // FIXME
...
@safe unittest
{
    import mystd.algorithm.internal : rndstuff;
    static bool even(int a) { return (a & 1) == 0; }
        ...
        && is(typeof(binaryFun!less(r.front, r.front)) == bool))
{
    ...
    import mystd.algorithm : swap, swapRanges; // FIXME
    import mystd.algorithm.comparison : min;
...
{
    import mystd.algorithm.internal : addressOf;
...
{
    import mystd.algorithm.mutation : swapAt;
...
{
    import mystd.algorithm.internal : rndstuff;
    import mystd.algorithm : swapRanges; // FIXME
    ...
    {
        import mystd.algorithm : swap; // FIXME
...
private template TimSortImpl(alias pred, R)
{
    ...
    body
    {
        import mystd.algorithm : reverse; // FIXME
    ...
    body
    {
    import mystd.algorithm : move; // FIXME
    ...
    body
    {
    import mystd.algorithm : copy; // FIXME
...
{
    // Issue 14223
    import mystd.range, mystd.array;
    ...
    if (isRandomAccessRange!R && hasLength!R)
{
    ...
    import mystd.range : zip, SortedRange;
...
unittest
{
    import mystd.algorithm.iteration : map;
...
@safe unittest
{
    ...
    import mystd.algorithm.iteration : reduce;
...
{
    import mystd.algorithm : find, reverse, swap; // FIXME
    import mystd.range : retro, takeExactly;
