 ...
 *
 * The mystd.cstream module bridges core.stdc.stdio (or mystd.stdio) and mystd.stream.
 * Both core.stdc.stdio and mystd.stream are publicly imported by mystd.cstream.
 *
 * Macros:
...
class CFile : Stream {
  ...
  unittest {
    ...
    auto stream_file = (mystd.file.deleteme ~ "-stream.txt").tempCString();
