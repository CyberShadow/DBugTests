...
deprecated("mystd.string.format now works in CTFE. Please use it instead.")
template Format(A...)
{
...
deprecated("mystd.conv.to now works in CTFE. Please use it instead.")
...
/// ditto
deprecated("mystd.conv.to!string now works in CTFE. Please use it instead.")
...
deprecated("to!string(mystd.conv.parse!uint(value)) now works in CTFE. Please use it instead.")
...
deprecated("to!string(mystd.conv.parse!int(value)) now works in CTFE. Please use it instead.")
