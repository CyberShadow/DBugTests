...
module mystd.syserror;

// Deprecated - instead use mystd.windows.syserror.sysErrorString()

deprecated("Please use mystd.windows.syserror.sysErrorString instead")
class SysError
{
    private import mystd.c.stdio;
    private import mystd.c.string;
