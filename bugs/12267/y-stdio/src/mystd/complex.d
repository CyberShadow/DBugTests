...
import mystd.format, mystd.math, mystd.numeric, mystd.traits;
...
/** Helper function that returns a _complex number with the specified
    ...
    is deduced using $(D mystd.traits.CommonType!(R, I)).
...
struct Complex(T)  if (isFloatingPoint!T)
{
    ...
    */
     ...
     * documentation for more information.
     */
    deprecated("Please use mystd.string.format instead.")
...
{
    return Complex!real(mystd.math.cos(y), mystd.math.sin(y));
}
