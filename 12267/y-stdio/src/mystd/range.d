...
import mystd.algorithm : copy, count, equal, filter, filterBidirectional,
    findSplitBefore, group, isSorted, joiner, move, map, max, min, sort, swap,
    until;
import mystd.traits;
import mystd.typecons : Tuple, tuple;
import mystd.typetuple : allSatisfy, staticMap, TypeTuple;
...
// tested individually, without needing to link to mystd.range.
enum dummyRanges = q{
...
{
    import mystd.string : format, outdent;
