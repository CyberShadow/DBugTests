...
import mystd.range.primitives;      // isInputRange, isOutputRange, isForwardRange, ElementType, hasLength
...
unittest
{
    import mystd.algorithm : sort, equal;
    import mystd.conv;
    import mystd.file;
    import mystd.stdio;
    ...
    { // Encoder and Decoder
        {
            string encode_file = mystd.file.deleteme ~ "-testingEncoder";
            mystd.file.write(encode_file, "\nf\nfo\nfoo\nfoob\nfooba\nfoobar");
        ...
        {
            string decode_file = mystd.file.deleteme ~ "-testingDecoder";
            mystd.file.write(decode_file, "\nZg==\nZm8=\nZm9v\nZm9vYg==\nZm9vYmE=\nZm9vYmFy");
