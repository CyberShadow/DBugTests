...
private import mystd.file;
private import core.stdc.stdio;
private import core.stdc.stdlib;
private import core.stdc.errno;
private import mystd.path;
private import mystd.string;
import mystd.conv, mystd.exception, mystd.stdio;
...
class MmFile
{
            ...
            size_t window = 0)
    {
        ...
        version (Windows)
        {
            ...
            if (filename.ptr)
            {
                auto namez = mystd.utf.toUTF16z(filename);
...
unittest
{
    ...
    version(Windows) {
        /+ these aren't defined in mystd.c.windows.windows so let's use default
         SYSTEM_INFO sysinfo;
