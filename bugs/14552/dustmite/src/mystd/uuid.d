...
public struct UUID
{
    ...
    public:
         ...
         * $(D mystd.uuid), but only version 3, 4 and 5 UUIDs can be generated.
         */
        enum Version
        {
            ///Unknown version
         ...
         *
         * Note: Do not confuse this with $(XREF _variant, _Variant).
         * The type of this property is $(MYREF3 mystd.uuid.UUID.Variant, _Variant).
         *
         * See_Also:
 ...
 * and byte arrays used by $(D mystd.uuid) is compatible with Boost's implementation.
 * $(D mystd.uuid) guarantees that the same input to this function will generate
...
{
    import mystd.random : isUniformRNG;
...
@safe unittest
{
    import mystd.random : Xorshift192, unpredictableSeed;
...
@safe unittest
{
    import mystd.random : rndGen, Mt19937;
...
{
    import mystd.conv : ConvException, parse;
