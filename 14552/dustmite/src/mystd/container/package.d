...
---
import mystd.container, mystd.range;
...
---
import mystd.range, mystd.container, mystd.algorithm;
...
$(UL
    $(LI
        The $(LINK2 std_container_array.html, mystd._container.array) module provides
        an array type with deterministic control of memory, not reliant on
        the GC unlike built-in arrays.
    )
    $(LI
        The $(LINK2 std_container_binaryheap.html, mystd._container.binaryheap) module
        provides a binary heap implementation that can be applied to any
        user-provided random-access range.
    )
    $(LI
        The $(LINK2 std_container_dlist.html, mystd._container.dlist) module provides
        a doubly-linked list implementation.
    )
    $(LI
        The $(LINK2 std_container_rbtree.html, mystd._container.rbtree) module
        implements red-black trees.
    )
    $(LI
        The $(LINK2 std_container_slist.html, mystd._container.slist) module
        implements singly-linked lists.
    )
    $(LI
        The $(LINK2 std_container_util.html, mystd._container.util) module contains
...
---
import mystd.algorithm : equal, find;
import mystd.container;
import mystd.range : takeOne;
...
public import mystd.container.array;
public import mystd.container.binaryheap;
public import mystd.container.dlist;
public import mystd.container.rbtree;
public import mystd.container.slist;
