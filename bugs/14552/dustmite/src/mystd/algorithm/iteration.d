...
/**
This is a submodule of $(LINK2 std_algorithm.html, mystd.algorithm).
 ...
 */
module mystd.algorithm.iteration;
...
template aggregate(fun...) if (fun.length >= 1)
{
    ...
    unittest
    {
        import mystd.algorithm.comparison : equal, max, min;
...
@safe unittest
{
    ...
    import mystd.stdio, mystd.range;
    import mystd.typecons : tuple;
...
private struct _Cache(R, bool bidir)
{
    ...
    private
    {
        import mystd.algorithm.internal : algoFormat;
...
template map(fun...) if (fun.length >= 1)
{
    ...
    {
        import mystd.typetuple : staticMap;
...
{
    import mystd.algorithm, mystd.datetime, mystd.file;
...
{
    import mystd.typecons : Rebindable, tuple, Tuple;
...
{
    import mystd.typecons : RefCounted;
...
template reduce(fun...) if (fun.length >= 1)
{
    ...
    static if (fun.length > 1)
        import mystd.typecons : tuple, isTuple;
...
@safe unittest
{
    import mystd.algorithm.comparison : max, min;
    import mystd.math : approxEqual;
    import mystd.range;
...
unittest
{
    ...
    auto foo()
    {
        import mystd.algorithm.comparison : max;
        import mystd.typecons : tuple, Tuple;
...
{
    import mystd.algorithm.searching : find;
...
private struct SplitterResult(alias isTerminator, Range)
{
    ...
    @property auto front()
    {
        ...
        {
            import mystd.range : takeExactly;
...
@safe unittest
{
    import mystd.algorithm.mutation : copy;
    import mystd.algorithm.comparison : equal;
